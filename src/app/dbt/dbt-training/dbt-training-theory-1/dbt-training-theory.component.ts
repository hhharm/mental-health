...
export class DbtTrainingTheoryComponent implements OnInit {
    ...
    Наиболее эффективной формой DBT является сочетание тренинга навыков и индивидуальной психотерапии.`
                    ...
                    content: ["Действительность и сам человек воспринимаются как нечто целое. Поэтому пытаясь изменить поведение, надо учитывать как непосредственно само поведение, так и контекст, в котором оно происходит.",
